# -*- coding: utf-8 -*-
"""
Created on Wed Jul 12 06:14:28 2017

@author: Ivan Liu
"""

from subprocess import check_output
#print(check_output(["ls", "../Common Data/Amazon"]).decode("utf8"))
...
df_test = pd.read_csv('../Common Data/Amazon/sample_submission_v2.csv')
...
for f, tags in tqdm(df_test.values, miniters=1000):
    img = cv2.imread('../Common Data/Amazon/test-jpg-all/{}.jpg'.format(f))
